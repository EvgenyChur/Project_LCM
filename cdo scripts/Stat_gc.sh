...
do
    ...
    cdo timcor ${DIR_IN}/"${refer_data}" ${DIR_IN}/"${model_ds}" ${DIR_OUT}/"Corr_GC"_"${ds_name}"_"${param}"."nc"
    # NetCDF > csv for correlation
    cdo -outputtab,date,lon,lat,value ${DIR_OUT}/"Corr_GC"_"${ds_name}"_"${param}"."nc" > ${DIR_OUT}/"Corr_GC"_"${ds_name}"_"${param}"."csv"
