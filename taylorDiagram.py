# -*- coding: utf-8 -*-
"""
The taylorDiagram the program for plotiing the taylor diagramm.

The main code for the Taylor diagram was copied from 
https://gist.github.com/ycopin/3342888

and Taylor diagram (Taylor, 2001) implementation.
...
Acknowledgment: Yannick Copin <yannick.copin@laposte.net
...
---------- ---------- ----                                                   
    1.1    2021-03-23 Evgenii Churiulin, Center for Enviromental System Research (CESR)
           Adaptation of tailor diagram to the research task
...
class TaylorDiagram(object):
    ...
    def __init__(self, refstd,
                 fig=None, rect=111, label='_', srange=(0, 9.49), extend=False):
        """
